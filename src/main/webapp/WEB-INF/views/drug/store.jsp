  ...
  <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      ...
      <script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f74af817be66222985c3a1eadae6b460&libraries=services"></script>
      <!-- ========================= CSS here ========================= -->
                  ...
                  <div class="google-map">
                    ...
                    <div class="mapouter" style=" height:360px ">
                      <div class="gmap_canvas" id="map" style="height:360px">
                        <iframe width="100%" height="300" id="gmap_canvas" frameborder="0" scrolling="no"
                    ...
                    <h3 class="block-title">처방 받은 약이 궁금하다면?
                      ...
                      <div class="row mb-3">
                        <form action="./list" class="row row-cols-lg-auto g-3 align-items-center">
                          ...
                          <div class="navbar bg-light">
                            <button class="btn btn-outline-success" type="submit"><i class="lni lni-search-alt"></i>
                              Search</button>
                          </div>
                        </form>
                      </div>
