...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="form-head post-ad-tab">
                        ...
                        <form class="default-form-style" action="./update" method="post" enctype="multipart/form-data" id="consultUpdateForm">
                        	<sec:authentication property="Principal" var="member"/>
                        	<input type="hidden" name="username" value="${member.username }">
                        	<input type="hidden" name="consultNum" value="${consultNum }" id="consultNumInput">
                            ...
                            <div class="button">
                                <button type="button" class="btn" id="consultUpdateBtn">물어보기</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script src="/js/consult/update.js"></script>
