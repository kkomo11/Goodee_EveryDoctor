                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group message">
                                                    <label>내 증상</label>
                                                    <textarea name="message">얼굴에 갑자기 붉은색 작은 점들이 생겼어요</textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group message">
                                                    <label>의사 소견</label>
                                                    <textarea name="message">풀에의한 접촉 알레르기 피부염으로 보입니다. 하이드로 코티존 연고 만으로는 치료 하기 힘들구요, 스테로이드 경구약을 짧은 기간이라도 더 복용 하시는 것이 좋습니다. 손에 있는 착색은 병이라기 보다, 풀에 있는 뭔가가 묻은 것으로 생각됩니다. 저절로 사라질 것으로 생각됩니다. 병이 다 치료 되고 나면, 소아과에 가시면 혈액을 이용한 알러지 항원 검사라는 것이 있는데 추천 드립니다.</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-12">
                                                <div class="form-group">
                                                    <label>진료비 결제</label>
                                                    <input name="first-name" type="text" value="1000원">
                                                </div>
                                            </div>
